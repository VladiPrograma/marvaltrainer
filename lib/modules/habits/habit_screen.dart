    ...
    return  GestureDetector(
      ...
      child: Stack(
        ...
        children: [
          ...
          CircleAvatar(
            backgroundImage:
            isNullOrEmpty(user.profileImage) ? null : Image.network(user.profileImage!, fit: BoxFit.fill,).image,
            child:  isNull(user.profileImage) ?
            Icon(Icons.person, size: 10.w, color: kGrey,)
                :
            null,
          ...
          Align(
            ...
            child: TextP1("${user.name.clearSimbols() } ${user.lastName}".maxLength(25),
                size: 3,
                maxLines: 1,
                textAlign: TextAlign.center
            ),
