                    ...
                    child:  Container(width: 100.w, height: 72.h,
                        ...
                        child: Watcher((context, ref, child) {
                              ...
                              itemBuilder: (context, index){
                                ...
                                DateTime? lastDate;
                                if(index!=0){ lastDate = data[index-1].date; }
                                logInfo('${lastDate?.id} --- ${message.date.id}');
                                return Column(
                                crossAxisAlignment: authUser.uid == message.user ? CrossAxisAlignment.end : CrossAxisAlignment.start,
                                children: [
                                  _DateLine(date: message.date.id == lastDate?.id ? null : message.date),
                                  message.type == MessageType.photo ? _ImageBox(message: message) : const SizedBox.shrink(),
