  ...
  Widget build(BuildContext context) {
    ...
    child: Column(
      ...
      children: [
        ...
        // Sleep & Weight
        Row(children: [
          Icon(CustomIcons.moon, color: daily.sleep>0 ? kBlue : kBlackSec, size: 6.w,),
          Icon(CustomIcons.moon, color: daily.sleep>1 ? kBlue : kBlackSec, size: 6.w,),
          Icon(CustomIcons.moon, color: daily.sleep>2 ? kBlue : kBlackSec, size: 6.w,),
          Icon(CustomIcons.moon, color: daily.sleep>3 ? kBlue : kBlackSec, size: 6.w,),
          Icon(CustomIcons.moon, color: daily.sleep>4 ? kBlue : kBlackSec, size: 6.w,),
          const Spacer(),
